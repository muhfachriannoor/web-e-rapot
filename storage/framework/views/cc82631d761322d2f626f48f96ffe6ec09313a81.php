      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Tambah Rapot Siswa</li>
          </ol>
        </div>
      </div>
    </div>
              ...
              <div class="card-body">
                <div class="form-group">
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label>Semesteraa</label>
                        <select name="semester" id="semester" class="form-control select2" required>
                          <option value="" selected disabled>-- PILIH SEMESTER --</option>
                          <option value="MID Semester Ganjil"
                            <?php echo e(collect(old('semester', ''))->contains('MID Semester Ganjil') ? 'selected="selected"' : ''); ?>>
                            MID Semester Ganjil</option>
                          <option value="Semester Ganjil"
                            <?php echo e(collect(old('semester', ''))->contains('Semester Ganjil') ? 'selected="selected"' : ''); ?>>
                            Semester Ganjil</option>
                          <option value="MID Semester Genap"
                            <?php echo e(collect(old('semester', ''))->contains('MID Semester Genap') ? 'selected="selected"' : ''); ?>>
                            MID Semester Genap</option>
                          <option value="Semester Genap"
                            <?php echo e(collect(old('semester', ''))->contains('Semester Genap') ? 'selected="selected"' : ''); ?>>
                  ...
                  <tbody>
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                        ...
                        <td><?php echo e($value->siswa->nama_siswa); ?></td>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/rapot/kelas-siswa/form-add.blade.php ENDPATH**/ ?>