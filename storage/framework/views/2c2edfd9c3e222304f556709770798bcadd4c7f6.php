                  ...
                  <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      ...
                      <td style="text-align: center; vertical-align: middle;">
                        <?php if($value->keputusan_kelas == 'Lulus'): ?>
                      ...
                      <td style="text-align: center; vertical-align: middle;"><a class="btn btn-primary"
                          href="<?php echo e(route('rapot.KeputusanLulusTidakLulusEdit', ['tahun_ajaran_id' => $dataTitle->tahun_ajaran_id, 'kelas_id' => $dataTitle->kelas_id, 'semester' => $semester, 'id_rapot' => $value->id_rapot])); ?>">Ubah</a>
                      </td>
                    </tr>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/rapot/keputusan-lulustidaklulus/keputusan-lulustidaklulus.blade.php ENDPATH**/ ?>