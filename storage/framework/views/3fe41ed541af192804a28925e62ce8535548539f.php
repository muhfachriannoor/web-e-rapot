      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- form start -->
            <form
              action="<?php echo e(route('rapot-kelas-siswa.storeinputNilaiMapel', ['kelas_siswa_id' => $dataKelasSiswa->id_kelas_siswa, 'semester' => $semester, 'mapel_id' => $dataMapel->id])); ?>"
                      ...
                      <tr>
                        ...
                        <td>
                          <textarea name="deskripsi_pengetahuan[<?php echo e($key); ?>]" class="form-control" rows="3"
                            placeholder="Deskripsi Pengetahuan"><?php echo e(old("deskripsi_pengetahuan.{$key}", '')); ?></textarea>
                        </td>
                        <td style="text-align: center; vertical-align: middle;"><input type="number"
                        ...
                        <td>
                          <textarea name="deskripsi_keterampilan[<?php echo e($key); ?>]" class="form-control" rows="3"
                            placeholder="Deskripsi Keterampilan"><?php echo e(old("deskripsi_keterampilan.{$key}", '')); ?></textarea>
                        </td>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/rapot/kelas-siswa/nilai-mapel-form-add.blade.php ENDPATH**/ ?>