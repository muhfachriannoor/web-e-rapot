                    ...
                    <tr>
                      ...
                      <td>
                        <form action="<?php echo e(route('data-akun.destroy', $value->id)); ?>" method="POST">
                          <a class="btn btn-info" href="<?php echo e(route('data-akun.show', $value->id)); ?>">Lihat</a>
                          <a class="btn btn-primary" href="<?php echo e(route('data-akun.edit', $value->id)); ?>">Ubah</a>
                          <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/akun/data-akun.blade.php ENDPATH**/ ?>