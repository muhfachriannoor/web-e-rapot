              ...
              <?php if($semester == 'Semester Ganjil'): ?>
                ...
                <?php else: ?>
                  <a class="btn btn-danger"
                    ...
                    Ekstrakurikuler</a>
                <?php endif; ?>
              <?php elseif($semester == 'Semester Genap'): ?>
                ...
                <tbody>
                  <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      ...
                      <td style="text-align: center; vertical-align: middle;">
                        <a class="btn btn-primary"
                          href="<?php echo e(route('rapot.SemesterEdit', ['tahun_ajaran_id' => $value->kelas_siswa->wali_kelas->tahun_ajaran_id, 'kelas_id' => $value->kelas_siswa->wali_kelas->kelas_id, 'semester' => $value->semester, 'id_rapot' => $value->id_rapot])); ?>">Ubah
                        </a>
                        <a class="btn btn-info"
                          href="<?php echo e(route('rapot.CetakRapot', ['tahun_ajaran_id' => $value->kelas_siswa->wali_kelas->tahun_ajaran_id, 'kelas_id' => $value->kelas_siswa->wali_kelas->kelas_id, 'semester' => $value->semester, 'id_rapot' => $value->id_rapot])); ?>"
                          target="_blank">Cetak
                          Rapot
                        </a>
                      </td>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/rapot/semester/semester.blade.php ENDPATH**/ ?>