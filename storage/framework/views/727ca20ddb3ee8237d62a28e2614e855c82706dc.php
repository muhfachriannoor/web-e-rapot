      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Lihat Ekstrakurikuler</li>
          </ol>
        </div>
      </div>
      <div class="row mb-2">
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Lihat Ekstrakurikuler</h3>
            </div>
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    ...
                    <th width="20%" style="text-align: center; vertical-align: middle;">Kegiatan Ekstrakurikuler</th>
                ...
                <tbody>
                  <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      ...
                      <td style="vertical-align: middle;"><?php echo e($value->kegiatan_ekstrakurikuler); ?></td>
                      <td style="vertical-align: middle;"><?php echo e($value->keterangan_ekstrakurikuler); ?></td>
                      <td style="text-align: center; vertical-align: middle;">
                        <a class="btn btn-primary"
                          href="<?php echo e(route('rapot.EkstrakurikulerEdit', ['tahun_ajaran_id' => $dataTitle->tahun_ajaran_id, 'kelas_id' => $dataTitle->kelas_id, 'semester' => $semester, 'id_ekstrakurikuler' => $value->id_ekstrakurikuler])); ?>">Ubah
                        </a>
                        </form>
                      </td>
                    </tr>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/rapot/ekstrakurikuler/ekstrakurikuler.blade.php ENDPATH**/ ?>