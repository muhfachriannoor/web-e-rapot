      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- form start -->
            <form action="<?php echo e(route('guru.update', $datanya->id)); ?>" method="POST" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="nip" class="form-control"
                          placeholder="Nomor Identitas Pegawai Negeri Sipil (NIP)" value="<?php echo e(old('nip', $datanya->nip)); ?>"
                          required>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="nama_guru" class="form-control"placeholder="Nama Guru"
                          value="<?php echo e(old('nama_guru', $datanya->nama_guru)); ?>" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="jabatan" class="form-control" placeholder="Jabatan"
                          value="<?php echo e(old('jabatan', $datanya->jabatan)); ?>" required>
                      </div>
                    </div>
                  </div>
                </div>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/guru/form-edit.blade.php ENDPATH**/ ?>