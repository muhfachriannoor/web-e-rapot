        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
            ...
            <li class="nav-item <?php if($title == 'Data Guru' or $title == 'Data Wali Kelas'): ?> menu-open <?php endif; ?>">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?php echo e(route('guru.index')); ?>" class="nav-link <?php echo e($title == 'Data Guru' ? 'active' : ''); ?>">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Data Guru</p>
                  </a>
                </li>
...
<?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/wakasekolah/dashboard.blade.php ENDPATH**/ ?>