      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- form start -->
            <form action="<?php echo e(route('kelas-siswa.store')); ?>" method="POST" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                      ...
                      <select name="tahun_ajaran_id" id="tahun_ajaran_id" class="form-control select2" required>
                        ...
                        <?php $__currentLoopData = $dataTahunAjaranWaliKelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dataTahunAjaranWaliKelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($dataTahunAjaranWaliKelas->tahun_ajaran->id); ?>"
                            <?php echo e(collect(old('tahun_ajaran_id', ''))->contains($dataTahunAjaranWaliKelas->tahun_ajaran->id) ? 'selected="selected"' : ''); ?>>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Kelas</label>
                      <select name="kelas_id" id="kelas_id" class="form-control select2" required disabled>
                        ...
                        <?php $__currentLoopData = $dataKelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dataKelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($dataKelas->kelas->id); ?>"
                            <?php echo e(collect(old('kelas_id', ''))->contains($dataKelas->kelas->id) ? 'selected="selected"' : ''); ?>>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="nama_wali_kelas" class="form-control" placeholder="Nama Wali"
                        value="<?php echo e(old('nama_wali_kelas', '')); ?>" required readonly>
                      <input type="hidden" name="wali_kelas_id" value="<?php echo e(old('wali_kelas_id', '')); ?>" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Siswa<code> .Multiple (Input lebih dari 1)</code></label>
                      <div class="select2-purple">
                        <select name="siswa_id[]" class="select2" multiple="multiple" data-placeholder="Pilih Semua Siswa"
                          ...
                          <?php $__currentLoopData = $dataSiswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dataSiswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($dataSiswa->id); ?>"
                              <?php echo e(collect(old('siswa_id', ''))->contains($dataSiswa->id) ? 'selected="selected"' : ''); ?>>
                              <?php echo e($dataSiswa->nisn); ?> | <?php echo e($dataSiswa->nama_siswa); ?>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/kelas-siswa/form-add.blade.php ENDPATH**/ ?>