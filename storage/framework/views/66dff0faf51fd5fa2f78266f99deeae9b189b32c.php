      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- form start -->
            <form action="<?php echo e(route('kelas.update', $datanya->id)); ?>" method="POST" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                      ...
                      <select name="tingkat_kelas_id" class="form-control select2" required>
                        ...
                        <?php $__currentLoopData = $datatingkatkelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $datatingkatkelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($datatingkatkelas->id); ?>"
                            <?php echo e(old('tingkat_kelas_id', $datanya->tingkat_kelas_id) == $datatingkatkelas->id ? 'selected="selected"' : ''); ?>>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="nama_kelas" class="form-control" placeholder="Nama Kelas"
                        value="<?php echo e(old('nama_kelas', $datanya->nama_kelas)); ?>" required>
                    </div>
                  </div>
                </div>
              </div>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/kelas/form-edit.blade.php ENDPATH**/ ?>