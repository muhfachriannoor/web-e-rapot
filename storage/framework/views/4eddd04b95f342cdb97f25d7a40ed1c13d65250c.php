      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- form start -->
            <form action="<?php echo e(route('importStore-siswa')); ?>" method="POST" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
              <div class="card-body">
                        ...
                        <code>
                          *Catatan
                          <ol>
                            ...
                            <li>Mohon diperhatikan saat mengisi NISN dan Nama Siswa!</li>
                            <li>Mohon diperhatikan Format mengisi Kolom Tanggal Lahir dan Diterima Tanggal
                              (tahun-bulan-hari)!</li>
                            <li>Jika NISN atau Nama Siswa sudah ada di sistem, maka sistem akan memberitahu bahwa data
                              sudah terdata di sistem</li>
              ...
              <div class="card-footer">
                <a class="btn btn-warning" href="<?php echo e(url('importfile/Contoh Data Siswa.xlsx')); ?>" target="_blank"> Contoh
                  File Download</a>
                <button type="submit" class="btn btn-primary">Simpan</button>
                <a class="btn btn-success" href="<?php echo e(route('siswa.index')); ?>"> Kembali</a>
              </div>
            </form>
          </div>
        </div>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/siswa/form-import.blade.php ENDPATH**/ ?>