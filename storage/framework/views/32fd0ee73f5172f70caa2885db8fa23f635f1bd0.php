      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('mapel-kelas.index')); ?>">Mata Pelajaran Kelas</a></li>
            <li class="breadcrumb-item active">Tambah Mata Pelajaran Kelas</li>
          </ol>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- form start -->
            <form action="<?php echo e(route('mapel-kelas.store')); ?>" method="POST" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                      ...
                      <select name="tahun_ajaran_id" class="form-control select2" required>
                        ...
                        <?php $__currentLoopData = $dataTahunAjaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dataTahunAjaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($dataTahunAjaran->id); ?>"
                            <?php echo e(collect(old('tahun_ajaran_id'))->contains($dataTahunAjaran->id) ? 'selected="selected"' : ''); ?>>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select name="tingkat_kelas_id" class="form-control select2" required>
                        ...
                        <?php $__currentLoopData = $dataTingkatKelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dataTingkatKelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option
                            value="<?php echo e($dataTingkatKelas->id); ?>"<?php echo e(collect(old('tingkat_kelas_id'))->contains($dataTingkatKelas->id) ? 'selected="selected"' : ''); ?>>
                            <?php echo e($dataTingkatKelas->tingkat_kelas); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Mata Pelajaran<code> .Multiple (Input lebih dari 1)</code></label>
                      <div class="select2-purple">
                        <select name="mapel_id[]" class="select2" multiple="multiple"
                          data-placeholder="Pilih Semua Mata Pelajaran" data-dropdown-css-class="select2-purple"
                          ...
                          <?php $__currentLoopData = $dataMapel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dataMapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option
                              value="<?php echo e($dataMapel->id); ?>"<?php echo e(collect(old('mapel_id'))->contains($dataMapel->id) ? 'selected="selected"' : ''); ?>>
                              <?php echo e($dataMapel->nama_mapel); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                      </div>
                    </div>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/mapel-kelas/form-add.blade.php ENDPATH**/ ?>