      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Lihat Keputusan Naik/Tidak Naik</li>
          </ol>
        </div>
      </div>
      <div class="row mb-2">
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Lihat Keputusan Naik/Tidak Naik</h3>
            </div>
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    ...
                    <th width="20%" style="text-align: center; vertical-align: middle;">Keputusan</th>
                    <th width="20%" style="text-align: center; vertical-align: middle;">Tingkat Kelas</th>
                  ...
                  <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      ...
                      <td style="text-align: center; vertical-align: middle;">
                        <?php if($value->keputusan_kelas == 'Naik Kelas'): ?>
                          <span class="badge bg-success"><?php echo e($value->keputusan_kelas); ?></span>
                        <?php else: ?>
                          <span class="badge bg-danger"><?php echo e($value->keputusan_kelas); ?></span>
                        <?php endif; ?>
                      </td>
                      <td style="text-align: center; vertical-align: middle;"><?php echo e($value->keputusan_tingkat_kelas); ?></td>
                      <td style="text-align: center; vertical-align: middle;"><a class="btn btn-primary"
                          href="<?php echo e(route('rapot.KeputusanNaikTidakNaikEdit', ['tahun_ajaran_id' => $dataTitle->tahun_ajaran_id, 'kelas_id' => $dataTitle->kelas_id, 'semester' => $semester, 'id_rapot' => $value->id_rapot])); ?>">Ubah</a>
                      </td>
                    </tr>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/rapot/keputusan-naiktidaknaik/keputusan-naiktidaknaik.blade.php ENDPATH**/ ?>