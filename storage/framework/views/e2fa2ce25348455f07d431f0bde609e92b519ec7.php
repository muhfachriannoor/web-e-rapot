          ...
          <div class="card card-primary">
            <div class="card-header">
              <h4 class="card-title">Data Siswa
                <b><?php echo e($datanya->nama_siswa); ?></b>
              </h4>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-sm-2">
                  <a href="<?php echo e(url('datafoto_siswa/' . $datanya->foto_siswa)); ?>" data-toggle="lightbox"
                    data-title="Foto <?php echo e($datanya->nama_siswa); ?>" data-gallery="gallery">
                    <img src="<?php echo e(url('datafoto_siswa/' . $datanya->foto_siswa)); ?>" class="img-fluid mb-2"
                      alt="Foto <?php echo e($datanya->nama_siswa); ?>">
                  </a>
                </div>
                <div class="col-sm-10">
                  <table class="table">
                    <tbody>
                      <tr>
                        ...
                        <td><b><?php echo e($datanya->nisn); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Nama Siswa</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->nama_siswa); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Jenis Kelamin</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->jenis_kelamin); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Tempat dan Tanggal Lahir</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->tempat_lahir); ?>,
                            <?php echo e($Carbon::parse($datanya->tanggal_lahir)->isoFormat('D MMMM Y')); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Agama</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->agama); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Status Dalam Keluarga</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->status_dalam_keluarga); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Anak Ke</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->anak_ke); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Alamat Rumah</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->alamat_rumah); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Nomor Telepon Rumah</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->no_telp_rumah); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Asal Sekolah</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->asal_sekolah); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Diterima Dikelas</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->diterima_dikelas); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Diterima Tanggal</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($Carbon::parse($datanya->tanggal_lahir)->isoFormat('D MMMM Y')); ?></b>
                        </td>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->nama_ayah); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Nama Ibu</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->nama_ibu); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Alamat Orang Tua</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->alamat_orangtua); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Nomor Telepon Orang Tua</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->no_telp_orangtua); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Pekerjaan Ayah</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->pekerjaan_ayah); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Pekerjaan Ibu</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->pekerjaan_ibu); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Nama Wali</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->nama_wali); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Alamat Wali</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->alamat_wali); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Nomor Telepon Wali</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->no_telp_wali); ?></b>
                        </td>
                      </tr>
                      <tr>
                        <td width="25%">Pekerjaan Wali</td>
                        <td width="1%" align="center">:</td>
                        <td><b><?php echo e($datanya->pekerjaan_wali); ?></b>
                        </td>
                      </tr>
                    </tbody>
                  </table>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/siswa/detail.blade.php ENDPATH**/ ?>