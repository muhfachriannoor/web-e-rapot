      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- form start -->
            <form action="<?php echo e(route('mata-pelajaran.update', $datanya->id)); ?>" method="POST"
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="nama_mapel" class="form-control" placeholder="Nama Mata Pelajaran"
                          value="<?php echo e(old('nama_mapel', $datanya->nama_mapel)); ?>" required>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="number" name="nilai_kkm" class="form-control" placeholder="00"
                          value="<?php echo e(old('nilai_kkm', $datanya->nilai_kkm)); ?>" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <select name="kelompok_mapel" class="form-control select2" required>
                          ...
                          <option value="Kelompok A"
                            <?php echo e(old('kelompok_mapel', $datanya->kelompok_mapel) == 'Kelompok A' ? 'selected="selected"' : ''); ?>>
                            Kelompok A</option>
                          <option value="Kelompok B"
                            <?php echo e(old('kelompok_mapel', $datanya->kelompok_mapel) == 'Kelompok B' ? 'selected="selected"' : ''); ?>>
                            Kelompok
                            B</option>
                        </select>
                      </div>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/mata-pelajaran/form-edit.blade.php ENDPATH**/ ?>