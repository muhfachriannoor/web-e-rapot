      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a
                href="<?php echo e(route('rapot.Prestasi', ['tahun_ajaran_id' => $datanya->rapot->kelas_siswa->wali_kelas->tahun_ajaran_id, 'kelas_id' => $datanya->rapot->kelas_siswa->wali_kelas->kelas_id, 'semester' => $datanya->rapot->semester])); ?>">Lihat
                Prestasi</a></li>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- form start -->
            <form
              action="<?php echo e(route('rapot.PrestasiUpdate', ['tahun_ajaran_id' => $datanya->rapot->kelas_siswa->wali_kelas->tahun_ajaran_id, 'kelas_id' => $datanya->rapot->kelas_siswa->wali_kelas->kelas_id, 'semester' => $datanya->rapot->semester, 'id_prestasi' => $datanya->id_prestasi])); ?>"
                        ...
                        <select name="rapot_id" class="form-control select2" required>
                          ...
                          <?php $__currentLoopData = $dataSiswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dataSiswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($dataSiswa->id_rapot); ?>"
                              <?php echo e(collect(old('rapot_id', $datanya->rapot_id))->contains($dataSiswa->id_rapot) ? 'selected="selected"' : ''); ?>>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="jenis_prestasi" class="form-control" placeholder="Jenis Prestasi"
                          value="<?php echo e(old('jenis_prestasi', $datanya->jenis_prestasi)); ?>" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <textarea name="keterangan_prestasi" class="form-control" placeholder="Keterangan Prestasi" rows="5" required><?php echo e(old('keterangan_prestasi', $datanya->keterangan_prestasi)); ?></textarea>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-footer">
                ...
                <a class="btn btn-success"
                  href="<?php echo e(route('rapot.Prestasi', ['tahun_ajaran_id' => $datanya->rapot->kelas_siswa->wali_kelas->tahun_ajaran_id, 'kelas_id' => $datanya->rapot->kelas_siswa->wali_kelas->kelas_id, 'semester' => $datanya->rapot->semester])); ?>">
                  Kembali</a>
              </div>
            </form>
          </div>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/rapot/prestasi-form-edit.blade.php ENDPATH**/ ?>