      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a
                href="<?php echo e(route('rapot.KeputusanNaikTidakNaik', ['tahun_ajaran_id' => $datanya->kelas_siswa->wali_kelas->tahun_ajaran_id, 'kelas_id' => $datanya->kelas_siswa->wali_kelas->kelas_id, 'semester' => $datanya->semester])); ?>">Lihat
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- form start -->
            <form
              action="<?php echo e(route('rapot.KeputusanNaikTidakNaikUpdate', ['tahun_ajaran_id' => $datanya->kelas_siswa->wali_kelas->tahun_ajaran_id, 'kelas_id' => $datanya->kelas_siswa->wali_kelas->kelas_id, 'semester' => $datanya->semester, 'id_rapot' => $datanya->id_rapot])); ?>"
                      ...
                      <div class="form-group">
                        ...
                        <select name="keputusan_kelas" id="keputusan_kelas" class="form-control select2" required
                          ...
                          <option value="Naik Kelas"
                            <?php echo e(old('keputusan_kelas', $datanya->keputusan_kelas) == 'Naik Kelas' ? 'selected="selected"' : ''); ?>>
                            Naik Kelas</option>
                          <option value="Tidak Naik Kelas"
                            <?php echo e(old('keputusan_kelas', $datanya->keputusan_kelas) == 'Tidak Naik Kelas' ? 'selected="selected"' : ''); ?>>
                            Tidak Naik Kelas</option>
                        </select>
                        <input type="hidden" name="tingkat_kelas_id"
                          value="<?php echo e($datanya->kelas_siswa->wali_kelas->kelas->tingkat_kelas_id); ?>" id="tingkat_kelas_id"
                          required>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="tingkat_kelas" id="tingkat_kelas" class="form-control" rows="3"
                          placeholder="" value="<?php echo e(old('tingkat_kelas', $datanya->keputusan_tingkat_kelas)); ?>" readonly
                          required>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card-footer">
                ...
                <a class="btn btn-success"
                  href="<?php echo e(route('rapot.KeputusanNaikTidakNaik', ['tahun_ajaran_id' => $datanya->kelas_siswa->wali_kelas->tahun_ajaran_id, 'kelas_id' => $datanya->kelas_siswa->wali_kelas->kelas_id, 'semester' => $datanya->semester])); ?>">
                  Kembali</a>
              </div>
            </form>
          </div>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/rapot/keputusan-naiktidaknaik/keputusan-naiktidaknaik-form-edit.blade.php ENDPATH**/ ?>