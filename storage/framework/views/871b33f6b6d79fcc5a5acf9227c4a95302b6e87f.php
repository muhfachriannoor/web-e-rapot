                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <textarea name="tanggapan_orangtua_wali" class="form-control" rows="5" placeholder="Tanggapan Orang Tua/Wali"><?php echo e(old('tanggapan_orangtua_wali', $datanya->tanggapan_orangtua_wali)); ?></textarea>
                      </div>
                    </div>
                  </div>
                </div>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/rapot/semester/semester-form-edit.blade.php ENDPATH**/ ?>