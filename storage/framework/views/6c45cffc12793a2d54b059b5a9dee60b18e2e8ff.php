      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- form start -->
            <form
              action="<?php echo e(route('rapot.EkstrakurikulerStore', ['tahun_ajaran_id' => $dataTitle->tahun_ajaran_id, 'kelas_id' => $dataTitle->kelas_id, 'semester' => $semester])); ?>"
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                        ...
                        <td style="text-align: center; vertical-align: middle;"><input type="text"
                            name="kegiatan_ekstrakurikuler1[<?php echo e($key); ?>]" class="form-control text-center"
                            placeholder="Kegiatan Ekstrakurikuler 1" value="Hizbul Wattan" readonly required>
                        </td>
                        <td>
                          <textarea name="keterangan_ekstrakurikuler1[<?php echo e($key); ?>]" class="form-control" rows="3"
                            placeholder="Keterangan Nilai" required><?php echo e(old("keterangan_ekstrakurikuler1.{$key}", '')); ?></textarea>
                        </td>
                        <td style="text-align: center; vertical-align: middle;"><input type="text"
                            name="kegiatan_ekstrakurikuler2[<?php echo e($key); ?>]" class="form-control text-center"
                            placeholder="Kegiatan Ekstrakurikuler 2" value="Tapak Suci (TS)" readonly required>
                        </td>
                        <td>
                          <textarea name="keterangan_ekstrakurikuler2[<?php echo e($key); ?>]" class="form-control" rows="3"
                            placeholder="Keterangan Nilai" required><?php echo e(old("keterangan_ekstrakurikuler2.{$key}", '')); ?></textarea>
                        </td>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/rapot/ekstrakurikuler/ekstrakurikuler-form-add.blade.php ENDPATH**/ ?>