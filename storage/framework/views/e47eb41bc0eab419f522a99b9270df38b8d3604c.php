      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- form start -->
            <form action="<?php echo e(route('mapel-kelas.update', $datanya->id)); ?>" method="POST" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                      ...
                      <select name="tingkat_kelas_id" class="form-control select2" required>
                        ...
                        <?php $__currentLoopData = $dataTingkatKelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dataTingkatKelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option
                            value="<?php echo e($dataTingkatKelas->id); ?>"<?php echo e(collect(old('tingkat_kelas_id', $datanya->tingkat_kelas_id))->contains($dataTingkatKelas->id) ? 'selected="selected"' : ''); ?>>
                    ...
                    <div class="form-group">
                      ...
                      <select name="mapel_id" class="form-control select2" required>
                        ...
                        <?php $__currentLoopData = $dataMapel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dataMapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($dataMapel->id); ?>"
                            <?php echo e(collect(old('mapel_id', $datanya->mapel_id))->contains($dataMapel->id) ? 'selected="selected"' : ''); ?>>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/mapel-kelas/form-edit.blade.php ENDPATH**/ ?>