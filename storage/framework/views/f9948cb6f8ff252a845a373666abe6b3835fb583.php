      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-12 mt-3">
          <div class="float-left">
            <a class="btn btn-success" href="<?php echo e(route('guru.create')); ?>"> Tambah Data</a>
            <a class="btn btn-primary" href="<?php echo e(route('importExcel-guru')); ?>"> Import Excel</a>
          </div>
        </div>
      </div>
    </div>
                ...
                <tbody>
                  <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      ...
                      <td><?php echo e($value->nama_guru); ?></td>
                      <td><?php echo e($value->jabatan); ?></td>
                      <td>
                        <form action="<?php echo e(route('guru.destroy', $value->id)); ?>" method="POST">
                          
                          <a class="btn btn-primary" href="<?php echo e(route('guru.edit', $value->id)); ?>">Ubah</a>
                          <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/guru/index.blade.php ENDPATH**/ ?>