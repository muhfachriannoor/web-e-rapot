      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="<?php echo e(route('data-akun.update', $datanya->id)); ?>" method="POST" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="nama" class="form-control" placeholder="Nama Lengkap"
                        value="<?php echo e($datanya->nama); ?>" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="email" name="email" class="form-control" placeholder="email@mail.com"
                        value="<?php echo e($datanya->email); ?>" required>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="username" class="form-control" placeholder="Username"
                        value="<?php echo e($datanya->username); ?>" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select name="level" class="form-control" required>
                        ...
                        <option value="2"
                          <?php echo e(collect(old('level', $datanya->level))->contains(2) ? 'selected="selected"' : ''); ?>>
                          Wakil Kepala Sekolah</option>
                        <option value="3"
                          <?php echo e(collect(old('level', $datanya->level))->contains(3) ? 'selected="selected"' : ''); ?>>
                          Wali Kelas</option>
                      </select>
                    </div>
                  </div>
...
<?php echo $__env->make('layouts/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/akun/ubah-akun.blade.php ENDPATH**/ ?>