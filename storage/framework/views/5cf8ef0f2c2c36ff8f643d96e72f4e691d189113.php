            ...
            <tbody class="text-center">
              ...
              <?php $__currentLoopData = $dataNilaiMapelKelompokA; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $dataNilaiMapelKelompokA): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  ...
                  <td class="text-left align-middle""><?php echo e($dataNilaiMapelKelompokA->mata_pelajaran->nama_mapel); ?></td>
                  <td class="align-middle"><b><?php echo e($dataNilaiMapelKelompokA->mata_pelajaran->nilai_kkm); ?></b></td>
                  <td class="align-middle">
                    <?php echo e($dataNilaiMapelKelompokA->nilai_pengetahuan); ?>

                  </td>
                  <td class="align-middle"><?php echo e($dataNilaiMapelKelompokA->predikat_pengetahuan); ?></td>
                  <td class="align-middle">
                    <?php echo e($dataNilaiMapelKelompokA->nilai_keterampilan); ?>

                  </td>
                  <td class="align-middle"><?php echo e($dataNilaiMapelKelompokA->predikat_keterampilan); ?></td>
                </tr>
              ...
              <?php $__currentLoopData = $dataNilaiMapelKelompokB; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $dataNilaiMapelKelompokB): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td class="align-middle"><?php echo e($loop->iteration); ?></td>
                  <td class="text-left align-middle"><?php echo e($dataNilaiMapelKelompokB->mata_pelajaran->nama_mapel); ?></td>
                  <td class="align-middle"><b><?php echo e($dataNilaiMapelKelompokB->mata_pelajaran->nilai_kkm); ?></b></td>
                  <td class="align-middle">
                    <?php echo e($dataNilaiMapelKelompokB->nilai_pengetahuan); ?>

                  </td>
                  <td class="align-middle"><?php echo e($dataNilaiMapelKelompokB->predikat_pengetahuan); ?></td>
                  <td class="align-middle">
                    <?php echo e($dataNilaiMapelKelompokB->nilai_keterampilan); ?>

                  </td>
                  <td class="align-middle"><?php echo e($dataNilaiMapelKelompokB->predikat_keterampilan); ?></td>
                </tr>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
          </table>
          ...
          <table class="table table-bordered" style="width: 30%">
            <tbody>
              <tr>
                ...
                <td class="text-center align-middle"><?php echo e($dataRapot->sakit); ?> hari</td>
              </tr>
              <tr>
                <td class="align-middle" width="50%">Izin</td>
                <td class="align-middle" width="1%">:</td>
                <td class="text-center align-middle"><?php echo e($dataRapot->izin); ?> hari</td>
              </tr>
              <tr>
                <td class="align-middle" width="50%">Tanpa Keterangan</td>
                <td class="align-middle" width="1%">:</td>
                <td class="text-center align-middle"><?php echo e($dataRapot->tanpa_keterangan); ?> hari</td>
              </tr>
            </tbody>
          </table>
        </div>
...
<?php /**PATH C:\xampp\htdocs\e-rapot\resources\views/admin/rapot/semester/cetak-mid-semester.blade.php ENDPATH**/ ?>