                ...
                <tbody>
                  @foreach ($data as $key => $value)
                    <tr>
                      ...
                      <td style="vertical-align: middle;">{{ $value->kegiatan_ekstrakurikuler }}</td>
                      <td style="vertical-align: middle;">{{ $value->keterangan_ekstrakurikuler }}</td>
                      <td style="text-align: center; vertical-align: middle;">
                        <a class="btn btn-primary"
                          href="{{ route('rapot.EkstrakurikulerEdit', ['tahun_ajaran_id' => $dataTitle->tahun_ajaran_id, 'kelas_id' => $dataTitle->kelas_id, 'semester' => $semester, 'id_ekstrakurikuler' => $value->id_ekstrakurikuler]) }}">Ubah
                        </a>
                        </form>
                      </td>
                    </tr>
