                  ...
                  @foreach ($data as $key => $value)
                    <tr>
                      ...
                      <td style="text-align: center; vertical-align: middle;">
                        @if ($value->keputusan_kelas == 'Naik Kelas')
                          <span class="badge bg-success">{{ $value->keputusan_kelas }}</span>
                        @else
                          <span class="badge bg-danger">{{ $value->keputusan_kelas }}</span>
                        @endif
                      </td>
                      <td style="text-align: center; vertical-align: middle;">{{ $value->keputusan_tingkat_kelas }}</td>
                      <td style="text-align: center; vertical-align: middle;"><a class="btn btn-primary"
                          href="{{ route('rapot.KeputusanNaikTidakNaikEdit', ['tahun_ajaran_id' => $dataTitle->tahun_ajaran_id, 'kelas_id' => $dataTitle->kelas_id, 'semester' => $semester, 'id_rapot' => $value->id_rapot]) }}">Ubah</a>
                      </td>
                    </tr>
                  @endforeach
                </tbody>
