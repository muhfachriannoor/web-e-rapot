        ...
        <div class="col-md-12 mt-3">
          <div class="float-left">
            <a class="btn btn-success"
              href="{{ route('rapot.PrestasiCreate', ['tahun_ajaran_id' => $dataTitle->tahun_ajaran_id, 'kelas_id' => $dataTitle->kelas_id, 'semester' => $semester]) }}">
              Tambah Prestasi</a>
                ...
                <tbody>
                  @foreach ($data as $key => $value)
                    <tr>
                      ...
                      <td style="vertical-align: middle;">{{ $value->jenis_prestasi }}</td>
                      <td style="vertical-align: middle;">{{ $value->keterangan_prestasi }}</td>
                      <td style="text-align: center; vertical-align: middle;">
                        <form
                          action="{{ route('rapot.PrestasiDestroy', ['tahun_ajaran_id' => $dataTitle->tahun_ajaran_id, 'kelas_id' => $dataTitle->kelas_id, 'semester' => $semester, 'id_prestasi' => $value->id_prestasi]) }}"
                          method="POST">
                          <a class="btn btn-primary"
                            href="{{ route('rapot.PrestasiEdit', ['tahun_ajaran_id' => $dataTitle->tahun_ajaran_id, 'kelas_id' => $dataTitle->kelas_id, 'semester' => $semester, 'id_prestasi' => $value->id_prestasi]) }}">Ubah
                          </a>
                          @csrf
                          @method('DELETE')
