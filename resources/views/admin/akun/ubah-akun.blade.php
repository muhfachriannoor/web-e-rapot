      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('data-akun.update', $datanya->id) }}" method="POST" enctype="multipart/form-data">
              @csrf
              @method('PUT')
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="username" class="form-control" placeholder="Username"
                        value="{{ $datanya->username }}" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select name="level" class="form-control" required>
                        ...
                        <option value="2"
                          {{ collect(old('level', $datanya->level))->contains(2) ? 'selected="selected"' : '' }}>
                          Wakil Kepala Sekolah</option>
                        <option value="3"
                          {{ collect(old('level', $datanya->level))->contains(3) ? 'selected="selected"' : '' }}>
                          Wali Kelas</option>
                      </select>
                    </div>
                  </div>
