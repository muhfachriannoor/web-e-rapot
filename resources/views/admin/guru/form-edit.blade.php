      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- form start -->
            <form action="{{ route('guru.update', $datanya->id) }}" method="POST" enctype="multipart/form-data">
              @csrf
              @method('PUT')
              <div class="card-body">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="nip" class="form-control"
                          placeholder="Nomor Identitas Pegawai Negeri Sipil (NIP)" value="{{ old('nip', $datanya->nip) }}"
                          required>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="nama_guru" class="form-control"placeholder="Nama Guru"
                          value="{{ old('nama_guru', $datanya->nama_guru) }}" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="jabatan" class="form-control" placeholder="Jabatan"
                          value="{{ old('jabatan', $datanya->jabatan) }}" required>
                      </div>
                    </div>
                  </div>
                </div>
